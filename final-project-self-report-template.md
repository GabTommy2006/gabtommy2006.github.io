...
|                |                   |
| -------------- | ----------------- |
| **Full name**  | _Hoàng Phúc Hưng_ |
| **Student ID** | _24020004_        |
| **Team**       | _WindToDo_        |
| **Role**       | _Frontend_        |
...
_- During that time, I attended two in-person group meetings: one in Room 403 at VN-UK, and the other at The Cozy Cafe on Duong Khue Street._

_- On April 29, the team changed the topic to developing a to-do list website._

_- At this point, the team started designing the to-do list website and named it WindToDo. We held another in-person meeting, again in Room 403, and began designing the UX/UI (we initially sketched it on the board, and then I personally redrew it using a drawing tablet) and creating the ERD. Initially, the team considered using Stitch for the design, but we ultimately designed it directly on Figma._
